...
def add_30_each():
    with app.app_context():
        ...
        # ===== 2. МАТЕРИНСКИЕ ПЛАТЫ (ровно 30 шт) =====
        motherboards = [
            # LGA1700 (15 шт)
            ...
            ('ASUS ROG STRIX X670E-E', 'AM5', 'ATX', 35500, 4.8),
        ]
        ...
        rams = [
            ...
            ('Patriot Viper 16GB DDR4-3600', 'DDR4', 6200, 4.5),
            ('TeamGroup T-Force 16GB DDR4-3600', 'DDR4', 6000, 4.4),
        ...
        gpus = [
            ...
            ('ASUS GeForce RTX 3060 Ti', 'RTX 3060 Ti', 200, 600, 30000, 4.6),
            ('Gigabyte GeForce RTX 3060 Ti', 'RTX 3060 Ti', 200, 600, 29500, 4.6),
            ('MSI GeForce RTX 3070', 'RTX 3070', 220, 650, 35000, 4.6),
            ('ASUS GeForce RTX 3070 Ti', 'RTX 3070 Ti', 290, 700, 40000, 4.7),
            ...
            ('Gigabyte GeForce RTX 4070 Ti', 'RTX 4070 Ti', 285, 700, 65000, 4.8),
            ...
            ('MSI GeForce RTX 4090', 'RTX 4090', 450, 850, 145000, 4.9),
            ('ASUS GeForce RTX 4090', 'RTX 4090', 450, 850, 150000, 4.9),
            ('Sapphire Radeon RX 6600', 'RX 6600', 132, 500, 20000, 4.4),
            ('PowerColor Radeon RX 6600 XT', 'RX 6600 XT', 160, 550, 23000, 4.5),
            ('ASUS Radeon RX 6650 XT', 'RX 6650 XT', 180, 550, 24000, 4.5),
            ('PowerColor Radeon RX 6700 XT', 'RX 6700 XT', 230, 650, 27000, 4.5),
            ('Sapphire Radeon RX 6750 XT', 'RX 6750 XT', 250, 650, 30000, 4.6),
            ('Sapphire Radeon RX 7600', 'RX 7600', 165, 550, 28000, 4.6),
            ('ASUS Radeon RX 7600 XT', 'RX 7600 XT', 190, 600, 32000, 4.6),
            ...
            ('ASRock Radeon RX 7900 XT', 'RX 7900 XT', 300, 750, 70000, 4.8),
            ('Sapphire Radeon RX 7900 XTX', 'RX 7900 XTX', 355, 800, 90000, 4.8),
            ('PowerColor Radeon RX 7900 XTX', 'RX 7900 XTX', 355, 800, 92000, 4.8),
            ('ASUS Radeon RX 7900 XTX', 'RX 7900 XTX', 355, 800, 95000, 4.8),
            ('XFX Radeon RX 7900 XTX', 'RX 7900 XTX', 355, 800, 93000, 4.8),
        ]
        ...
        print('=' * 60)
        print('✅ БАЗА ДАННЫХ ПОПОЛНЕНА! РОВНО 30 КОМПОНЕНТОВ КАЖДОГО ТИПА')
        print('=' * 60)
